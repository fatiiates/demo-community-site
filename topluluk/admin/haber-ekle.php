...
<div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Haber Ekleme Panelindesiniz</h1>
                    ...
                    <?php } if($_GET['durum'] == "makale"){ ?>
                        <div class="alert alert-danger alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                MAKALESİ AYNI OLAN HABERLER EKLENEMEZ.
                            </div>
                    ...
                    <?php } ?>
                        ...
                        <h1 class="page-subhead-line">Haber Ekliyorsunuz...</h1>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">HABER EKLEME</div>
                            ...
                            <form action="netting/islem.php" onsubmit="return validateMakale()" name="imageInsert" method="POST" enctype="multipart/form-data">
                                <div class="col-md-12">
                                    <div class="form-group col-md-12" >
                                        ...
                                        <input class="form-control" type="text" name="haber_ad"  required >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-12" >
                                        ...
                                        <input class="form-control" type="text" name="haber_baslik" required >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group col-md-12" >
                                        <label>Haber Açıklaması*</label>
                                        <textarea class="form-control" cols="5" rows="10" type="text" name="haber_aciklama"  required ></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <button type="submit" style="margin-left:15px" value="1"  class="btn btn-danger" name="haberEkle">Haberi Kaydet</button>
                                </div>
                            </form>
                        </div>
                </div>
